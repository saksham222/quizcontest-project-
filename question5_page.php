      ...
      <div class="container">
        ...
        <div class="card">
               ...
               <?php
                     ...
                     $sql1 = "SELECT * FROM question where qid=5";
                        ...
                        ?> 
                         ...
                         <?php
$sql1 = "SELECT * FROM answer where ansid=5";
                        $result1 = mysqli_query($con, $sql1);
                        ...
                        <div class="card-body">
                         ...
                         <?php
                            ...
                            ?>
                            <br>
                  <a href="h1.php" class="btn btn-primary d-block m-auto text-white" > GOTO FIRST Question </a> 
                         </form>
                         </div> 
                         </div>
                         <br>
