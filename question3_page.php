      ...
      <div class="container">
        ...
        <div class="card">
               ...
               <?php
                     ...
                     $sql1 = "SELECT * FROM question where qid=3";
                        ...
                        ?> 
                         ...
                         <?php
$sql1 = "SELECT * FROM answer where ansid=3";
                        $result1 = mysqli_query($con, $sql1);
                        ...
                        <div class="card-body">
                         ...
                         <?php
                            ...
                            ?>
                            <br>
                  <a href="h4.php" class="btn btn-primary d-block m-auto text-white" > Next Question </a> 
                         </form>
                         </div> 
                         </div>
                         <br>
